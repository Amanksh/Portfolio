        ...
        <div className="flex flex-col justify-center items-center text-center sm:w-[50%]">
          ...
          <div className=" gap-16 mt-5">
            ...
            >
              ...
              >
                <input
                  className="w-full text-primary bg-para rounded-lg font-semibold placeholder-opaque-bsdadlack p-3"
                  type="text"
                  placeholder="NAME"
                  {...register("name", {
                    required: true,
                ...
                <input
                  className="w-full bg-para text-primary rounded-lg font-semibold placeholder-opaque-black p-3 mt-5"
                  type="text"
                  placeholder="EMAIL"
                  {...register("email", {
                    required: true,
                ...
                <textarea
                  className="w-full bg-para rounded-lg text-primary shadow-lg font-semibold placeholder-opaque-black p-3 mt-5"
                  name="message"
                  placeholder="MESSAGE"
                  rows="4"
                  cols="50"
