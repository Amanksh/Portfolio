    ...
    >
      <div className="flex items-center justify-between mx-auto w-5/6  ">
        ...
        {!isAboveSmallScreens && isMenuToggled && (
          <div className="fixed right-0 bottom-0 h-full  bg-primary border-l-2 shadow-[inset_0_-1px_3px_rgba(0,0,0,0.2)] shadow-slate-600 w-[280px] mb-bg">
            ...
            <div className="flex flex-col h-[85%]  text-2xl text-headcolor font-bold items-center justify-start mt-6 font-playfair ">
              <AnchorLink
                className={`${
                  selectedPage == "home" ? " text-primary bg-slate-300" : ""
                } flex gap-2 items-center  w-[100%] justify-center p-4 border-b-2   text-headColor text-2xl rounded-lg`}
              ...
              <AnchorLink
                ...
                } flex gap-2 items-center font-bold text-2xl  w-[100%] justify-center p-4 border-b-2  text-headColor rounded-lg `}
                href="#about"
              ...
              <AnchorLink
                ...
                } flex gap-2 items-center  w-[100%] justify-center p-4 border-b-2 text-2xl text-headColor rounded-lg `}
